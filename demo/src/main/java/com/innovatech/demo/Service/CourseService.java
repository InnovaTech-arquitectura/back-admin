...
public class CourseService {
    ...
    public Course addCourse(Course newCourse) {
        ...
        // Evaluar si los lugares son mayores que 0 y si la fecha del curso es posterior
        // a la fecha actual
        if (newCourse.getPlaces() > 0 && newCourse.getDate().after(now)) {
            ...
            throw new IllegalArgumentException(
                    "Places must be greater than 0 and date muyt be greater than todays date");
        }
    }
        ...
        if (editedCourse.getPlaces() > 0
            ...
            if (!(editedCourse.getLink() == null ||
                ...
                if (courseFull.getCourseEntrepreneurship().size() <= editedCourse.getPlaces()) {
                    ...
                    throw new IllegalArgumentException(
                            "Edited places must be equal o greater compared to the current subscribers");
                }
